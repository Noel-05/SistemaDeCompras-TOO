    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
              <h1 class="text-titles"><i class="zmdi zmdi-assignment-o zmdi-hc-fw"></i> <strong>Reporte Stock de Inventario a nivel de Existencias</strong></h1>
            </div>
        </div>
...
<!--                                                 <div class="form-group">
                                                ...
                                                <table class="table table-hover text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>${inv.codArticulo}</td>
                                                            <td>${inv.nomArticulo}</td>
