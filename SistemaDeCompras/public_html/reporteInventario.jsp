    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
              <h1 class="text-titles"><i class="zmdi zmdi-assignment-o zmdi-hc-fw"></i> <strong>Reporte Inventario</strong></h1>
            </div>
        </div>
                                    ...
                                    <div class="col-xs-12 col-md-10 col-md-offset-1">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-10 col-md-offset-1">
                                                ...
                                                <form method="get" action="controladorreporteinventario">

                                                    <input type="hidden" name="instruccion" value="consulta">

                                                    <div class="form-group">
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Seleccione el articulo</label>
                                               
                                                            <select class="form-control" name="articulo" required="required">
                                                                <option>Seleccione el Articulo a Consultar...</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label">Fecha a partir de cuando desea el reporte</label>
