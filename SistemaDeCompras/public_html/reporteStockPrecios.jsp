    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
              <h1 class="text-titles"><i class="zmdi zmdi-assignment-o zmdi-hc-fw"></i> <strong>Reporte Stock de Inventario a nivel de Precio</strong></h1>
            </div>
        </div>
                                                ...
                                                <table class="table table-hover text-center">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">Precio Total en Inventario</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <c:forEach var="cp" items="${LISTACOSTOPROMEDIO}">
                                                        <tr>
                                                            <td>${cp.codArticulo}</td>
                                                            <td>${cp.nomArticulo}</td>
                                                            <td>${cp.unidadArticulo}</td>
                                                            <td>${cp.cantidadCP}</td>
                                                            <td>${cp.valorUnidadCP}</td>
                                                            <td>${cp.valorTotalCP}</td>
                                                        </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
