    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
              <h1 class="text-titles"><i class="zmdi zmdi-shopping-cart-add zmdi-hc-fw"></i> <strong>Actualizar Requisicion de Art&iacute;culos.</strong></h1>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-10 col-md-offset-1">
                                        ...
                                        <form method="get" action="controladorrequisicion" >
                                            ...
                                            <input type="hidden" name="numero" value="${REQUISICIONACTUALIZAR.numReq}">
                                            
                                            <div class="form-group label-floating">
                                                <label class="control-label">Fecha del Pedido</label>
                                                <input class="form-control" type="date" name="fechaPedido" required="required" value="${REQUISICIONACTUALIZAR.fechaPedidoReq}">
                                            </div>

                                            <div class="form-group label-floating">
                                                <label class="control-label">Fecha Entrega</label>
                                                <input class="form-control" type="date" name="fechaEntrega" required="required" value="${REQUISICIONACTUALIZAR.fechaEntregaReq}">
                                            </div>

                                            <div class="form-group label-floating">
                                                <label class="control-label">Cantidad</label>
                                                <input class="form-control" type="number" name="cantidad" required="required" value="${REQUISICIONACTUALIZAR.cantArt}">
                                            </div>

                                            <div class="form-group label-floating">
                                                <label class="control-label">Art&iacute;culo</label>
                                                <input class="form-control" type="text" value="${REQUISICIONACTUALIZAR.codArticulo}" disabled="disabled">
                                                <input class="form-control" type="hidden" name="articulo" required="required" value="${REQUISICIONACTUALIZAR.codArticulo}" >
                                            </div>

                                            <div class="form-group label-floating">
                                                <label class="control-label">Carnet</label>
                                                <input class="form-control" type="text" value="${REQUISICIONACTUALIZAR.carnetEmpleado}" disabled="disabled">
                                                <input class="form-control" type="hidden" name="carnet" required="required" value="${REQUISICIONACTUALIZAR.carnetEmpleado}">
                                            </div>                                          
